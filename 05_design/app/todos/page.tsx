...
export default function TodosPage() {
  const { todos, fetchTodos, addTodo, updateTodo, goals, fetchGoals, weeklyPlans, fetchWeeklyPlans } =
    useStore();
  ...
  return (
    <div>
      ...
      <Modal isOpen={isModalOpen} onClose={handleClose} title={editingTodo ? '할 일 수정' : '새 할 일'}>
        <TodoForm
          goals={goals}
